 ...
 * devtree related software issue. Incase still the issue persist
 * after reboot recommending to replace primary processor.
 */
...
void processIplErrorCallback(const ipl_error_info& errInfo)
{
    ...
    switch (errInfo.type)
    {
        ...
        case IPL_ERR_PRI_PROC_NON_FUNC:
            // Handle non function boot processor error.
