...
void checkHostRunning()
{
    ...
    // We should "never" make it here. If we did it implies no master processor
    // was found. Once again, rely on systemd recovery if this happens
    log<level::ERR>("No master processor found in checkHostRunning");
    throw std::runtime_error("No master processor found in checkHostRunning");
}
...
void clearHostRunning()
{
    ...
    log<level::ERR>("No master processor found in clearHostRunning");
}
