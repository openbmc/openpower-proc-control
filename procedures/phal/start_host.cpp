 ...
 *        procedure callouts for the hardware isolation policy
 *        settings failures.
 *
 * @param[in] procedureCode - The procedure code include in the callouts
 * @param[in] priority - The priority for the procedure callouts
