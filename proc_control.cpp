...
{
    std::make_tuple("startHost", openpower::p9_procedures::startHost),
    std::make_tuple("vcsWorkaround", openpower::p9_procedures::vcsWorkaround)
};
...
int main(int argc, char** argv)
{
    ...
    auto procedure = find_if(procedures.begin(), procedures.end(), finder);
