...
int main(int argc, char* argv[])
{
    ...
    constexpr auto BUSPATH_NMI_CONFIG =
        "/xyz/openbmc_project/control/host0/nmi";
    constexpr auto BUSNAME_NMI_CONFIG =
    ...
    sdbusplus::server::manager::manager objManager(bus, BUSPATH_NMI_CONFIG);
    bus.request_name(BUSNAME_NMI_CONFIG);

    try
    {
        openpower::proc::NMI NMI(bus, BUSPATH_NMI_CONFIG);
