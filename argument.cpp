...
void ArgumentParser::usage(char** argv)
{
    ...
    std::cerr << "    --exec            <step name>..<step name>\n";
    std::cerr << "                      Execute a single step or a\n";
    std::cerr << "                      rage of steps. default mode is step\n";
    std::cerr << "    --step            <step number>..<step number>\n";
    std::cerr << "                      Execute a single step or a\n";
    std::cerr << "                      rage of steps. default mode is step\n";
...
const char* ArgumentParser::optionstr = "miesdth?";

const std::string ArgumentParser::true_string = "true";
const std::string ArgumentParser::empty_string = "";

ExecMode GetBootMode(std::string mode, ExecMode def)
{
    if (mode.empty())
    {
        return def;
...
void parseArguments(int argc, char** argv, optstruct &opt)
{
    ...
    {
        opt.mode = GetBootMode(mode, ExecMode::STEP);
